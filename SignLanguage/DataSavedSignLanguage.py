...
# Ask the user for the number of gestures to train
numGest = int(input("How Many Gestures Do You want to Train? (Enter 0 to use saved data): "))
...
if numGest > 0:
    ...
    try:
        with open('gesture_data.pkl', 'rb') as f:
            knownGestures, gestNames = pickle.load(f)
        print("Loaded trained data from file.")
    except FileNotFoundError:
        print("No trained data found. Please train at least one gesture.")
        exit()
            ...
            if cv2.waitKey(1) & 0xff == ord('t'):
                ...
                if trainCnt == numGest:
                    ...
                    with open('gesture_data.pkl', 'wb') as f:
                        pickle.dump((knownGestures, gestNames), f)
                    print("Trained data saved to file.")
